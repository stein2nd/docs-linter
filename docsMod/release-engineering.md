...
すべてのリリースは、セキュリティを最優先とします。

### 自動化 First

可能な限り、CI/CD による自動化を採用します。
...
リリース KPI を継続的に分析し、サプライチェーンを改善します。

### 責務

同一入力から、同一成果物を生成します。

## 26. ソフトウェア・サプライチェーン・ガバナンス (Advanced)

本章は、ソフトウェア・サプライチェーンの長期運用ポリシーを定義します。

本章は、リリース・エンジニアリングを補完し、プラットフォーム全体のセキュリティ、ガバナンス、および「オペレーショナル・エクセレンス」を保証します。

## 27. SLSA (ソフトウェア成果物のサプライチェーン・レベル) 方針

ソフトウェア・サプライチェーンは、来歴およびビルドの完全性を保証します。
...
ビルドの完全性を保証できない成果物は、公開してはなりません。

## 28. 信頼されたビルダー方針

リリースは、「信頼されたビルダー」上でのみ実施します。
...
ローカル環境から直接、リリース成果物を公開してはなりません。

## 29. キー・ローテーション方針

署名鍵および認証情報は、定期的に更新します。
...
新機能は、フリーズ中に追加してはなりません。

## 32. 保守時間の方針

定期リリースおよび保守時間帯を定義します。
...
* 変更管理の方針
* 横断の原則
* SLSA (ソフトウェア成果物のサプライチェーン・レベル) 方針
* 信頼されたビルダー方針
* キー・ローテーション方針
* パッケージ出自の検証
* リリース・フリーズ方針
...
## 39. ソフトウェア・サプライチェーン・ガバナンス ADR (アーキテクチャ決定記録)
