...
メジャーバージョンは、最低12か月間サポートすることを推奨します。

## 35. SDK 移行方針

メジャーバージョン更新時の移行契約を定義します。
...
非推奨 API は、最低1メジャーバージョン維持することを推奨します。
...
## 41. プラットフォーム・ガバナンス ADR (アーキテクチャ決定記録)
