...
* **README ドキュメント構成** — npm 主導線は [README.md](../../../README.md)。Git Submodule 手順は [docs/git_submodule.md](../../git_submodule.md) に切り出し (後方互換・非推奨)。
...
* フェーズ4 **P2 (CLI ツール)** — [cli_tooling_spec.md](../../cli_tooling_spec.md) **100% クローズ** (2026-06-02)
    ...
    * **ドキュメント同期 済** (2026-06-02) — [README.md](../../../README.md) · [npm_usage.md](../../npm_usage.md) · [docs/git_submodule.md](../../git_submodule.md) への `init` / `doctor` / Submodule 導線
...
| [docs/git_submodule.md](../../git_submodule.md) | Git Submodule 利用手順 (後方互換・非推奨)。README から導線 |
...
| [README.md](../../../README.md) | npm 主導線 · Quick Start · [npm_usage.md](../../npm_usage.md) 導線 · [git_submodule.md](../../git_submodule.md) (Submodule・非推奨) · ロードマップ / ガバナンス — 推奨 #4–#5 |

## 機能一覧 (実装状況サマリー)

| 機能名 (仕様セクション) | 実装済み/未実装 | 実装％ | 完了条件 (要約) | 備考 |
| --- | --- | ---: | --- | --- |
| [Publishing - フェーズ1優先タスク](../../npm_package_spec.md#publishing---フェーズ1優先タスク) | 実装済み | 100 | pack / dry-run / tarball / registry / 受け入れ (#1–2, #4–9, #11–12) | npm 最新 **`@s2j/docs-linter@1.0.15`** (2026-06-02) |
...
| [`package.json` メタデータ更新](../../npm_package_spec.md#packagejson-メタデータ更新) | 実装済み | 100 | `@s2j/docs-linter`、semver、`LICENSE` 等 | **`1.0.15`** (#5–6) |
...
| [README 移行](../../npm_package_spec.md#readme-移行) | **済** | 100 | npm 主導線 + [git_submodule.md](../../git_submodule.md) (Submodule 非推奨) + VSCode 定着 | フェーズ3 推奨 #2–3 **済** (#6 **済**) |
...
| P2 ドキュメント同期 (CLI) | **済** | 100 | README / [npm_usage.md](../../npm_usage.md) / [git_submodule.md](../../git_submodule.md) への `init` / `doctor` / Submodule 導線 | 更新 **2026-06-02** · 仕様 [ドキュメントの同期](../../cli_tooling_spec.md#ドキュメントの同期) |
...
| [CLI コマンド - init](../../cli_tooling_spec.md#cli-コマンド---init) | **済** | 100 | 通常 / Dry Run / `--output` モード、プリセット、上書き、`package.json` `lint:docs` | main **2026-05-30** · npm **`1.0.14`–`1.0.15`** |
| [CLI コマンド - init テスト仕様](../../cli_tooling_spec.md#cli-コマンド---init-テスト仕様) | **済** | 100 | INIT-001〜012 · `scripts/test-init.sh` · GHA 再現 | 検証 **2026-06-02** PASS |
| [CLI コマンド - doctor](../../cli_tooling_spec.md#cli-コマンド---doctor-コマンド) | **済** | 100 | 環境診断 (PASS / WARN / FAIL)、7 項目チェック、`--path` / `--help` | main **2026-06-02** · npm **`1.0.14`–`1.0.15`** · Fixes [#31](https://github.com/stein2nd/docs-linter/issues/31) |
| [CLI コマンド - doctor テスト仕様](../../cli_tooling_spec.md#cli-コマンド---doctor-テスト仕様) | **済** | 100 | DOCTOR-001〜015 · フィクスチャ · GHA 再現 | 検証 **2026-06-02** PASS |
...
| 10 | README / [npm_usage.md](../../npm_usage.md) / install examples の整合 | **済** | 100 | npm 主導線 ([README](../../../README.md)) · Submodule ([git_submodule.md](../../git_submodule.md)) · [npm_usage.md](../../npm_usage.md) |
...
* README への npm 手順の併記 (フェーズ1時点は Submodule 主導線) および [npm_usage.md](../../npm_usage.md) への導線 — 現在は npm 主導線、Submodule 手順は [docs/git_submodule.md](../../git_submodule.md)
...
| `docs/npm_usage.md` | `lint:docs` before/after、`--profile`、CI、VSCode・`extends` 移行例 | #10, #14, #15 |
| `docs/npm_package_spec.md` | フェーズ1優先タスク・**パッケージ構成**・GHA・残タスクの注記 | 文書 |
| `docs/npm_auth_secret_manage_spec.md` | 認証優先順位 (OIDC > 自動化トークン > 手動)、secret 運用、GHA 例 | 文書 |
...
**備考 (推奨 #2–3)**: README は npm 主導線。Git Submodule 手順は [docs/git_submodule.md](../../git_submodule.md) に切り出し (非推奨)。VSCode 設定は実利用ベースで標準設定として定着。
...
| [docs/git_submodule.md](../../git_submodule.md) | Git Submodule 利用手順 (後方互換・非推奨) — README から切り出し | ドキュメント構成 **2026-06-02** |
...
| **P2 ドキュメント同期** | **100%** — [README.md](../../../README.md) · [npm_usage.md](../../npm_usage.md) · [git_submodule.md](../../git_submodule.md) への `init` / `doctor` / Submodule 導線 **済** (更新 **2026-06-02**) |
...
| P2 ドキュメント同期 | README / [npm_usage.md](../../npm_usage.md) への `init` / `doctor` 導線 | **済** | 100 | 更新 **2026-06-02** |
...
| D3 | `doctor` テスト仕様 (DOCTOR-001〜015) | **済** | 100 | [cli_tooling_spec.md](../../cli_tooling_spec.md#cli-コマンド---doctor-テスト仕様) · フィクスチャ定義 |
...
| S3 | [npm_usage.md](../../npm_usage.md) — 初回セットアップ (`init`) | **済** | 100 | `npx @s2j/docs-linter init` · 生成ファイル — 更新 **2026-06-02** |
| S4 | [npm_usage.md](../../npm_usage.md) — 設定確認 (`doctor`) | **済** | 100 | `doctor` コマンド · 診断項目 · CI 導入後の確認例 — 更新 **2026-06-02** |
...
* **P2 / CLI `init`**: main **2026-05-30** — [cli_tooling_spec.md](../../cli_tooling_spec.md) 仕様 · [src/bin/init.ts](../../../src/bin/init.ts) · [scripts/test-init.sh](../../../scripts/test-init.sh) · `npm run test:init` (INIT-001〜012) · [ci.yml](../../../.github/workflows/ci.yml) GHA 統合
* **P2 / CLI `doctor`**: main **2026-06-02** (Fixes [#31](https://github.com/stein2nd/docs-linter/issues/31)) — [src/bin/doctor.ts](../../../src/bin/doctor.ts) · [scripts/test-doctor.sh](../../../scripts/test-doctor.sh) · `npm run test:doctor` (DOCTOR-001〜015) · [ci.yml](../../../.github/workflows/ci.yml) GHA 統合
* **P2 / ドキュメント同期**: **2026-06-02** — [README.md](../../../README.md) · [npm_usage.md](../../npm_usage.md) · [docs/git_submodule.md](../../git_submodule.md) — `init` / `doctor` / Submodule 導線
...
| [README.md](../../../README.md) | `init` (セットアップ) · `doctor` (環境チェック) · [npm_usage.md](../../npm_usage.md) 導線 | P2 / S1–S2 · **2026-06-02** |
| [docs/git_submodule.md](../../git_submodule.md) | Git Submodule 利用手順 (非推奨) — README から切り出し | ドキュメント構成 · **2026-06-02** |
| [npm_usage.md](../../npm_usage.md) | 初回セットアップ (`init`) · 設定確認 (`doctor`) · 診断項目 · CI 導入後の確認例 | P2 / S3–S4 · **2026-06-02** |
...
| [cli_tooling_spec.md](../../cli_tooling_spec.md) | CLI ツール仕様 — `init` / `init` テスト仕様 / `doctor` / `doctor` テスト仕様 | P2 |
...
* **CLI ツール (P2)**:
    ...
    * ユーザー向け導線 … [README.md](../../../README.md) · [npm_usage.md](../../npm_usage.md) · [docs/git_submodule.md](../../git_submodule.md) に `init` / `doctor` / Submodule 手順 **済**。
* **root ミラー**:
...
* **フェーズ3 / 4**:
    ...
    * フェーズ4 **P2 (CLI ツール)** … **クローズ** (2026-06-02) — `init` (2026-05-30) / `doctor` (2026-06-02) 本実装 + 自動テスト + GHA + [README.md](../../../README.md) / [npm_usage.md](../../npm_usage.md) / [git_submodule.md](../../git_submodule.md) ドキュメント同期 **500/500**
